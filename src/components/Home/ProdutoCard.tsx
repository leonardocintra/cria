...
import { produtoData } from "../../pages/api/produtos/ProdutoData";
          ...
          <div className="flex flex-col md:flex-row items-center justify-center w-4/5">
            <Link href="produto">
              <div className="basis-1/3 bg-lime-100 p-5 rounded-md mt-4">
                <h3 className="text-4xl font-montserrat text-center font-bold">
                  {produto.titulo}
                </h3>
              ...
              <div className="basis-2/3 grid md:grid-cols-3 gap-2 items-center">
