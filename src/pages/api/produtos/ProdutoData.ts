...
export const produtoData: IProdutoDetalhe[] = [
  {
    ...
    fotos: [
      { alt: "rosca-1", src: "/img/rosca-esparramadora/1.png" },
      { alt: "rosca-2", src: "/img/rosca-esparramadora/2.png" },
      { alt: "rosca-3", src: "/img/rosca-esparramadora/3.png" },
      { alt: "rosca-4", src: "/img/rosca-esparramadora/4.png" },
      { alt: "rosca-5", src: "/img/rosca-esparramadora/5.png" },
      { alt: "rosca-6", src: "/img/rosca-esparramadora/6.png" },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    fotos: [
      { alt: "pato-1", src: "/img/pato/1.png" },
      { alt: "pato-2", src: "/img/pato/2.png" },
      { alt: "pato-3", src: "/img/pato/3.png" },
    ],
  },
  {
    id: 4,
    ...
    fotos: [
      { alt: "silo-1", src: "/img/silo/1.png" },
      { alt: "silo-2", src: "/img/silo/2.png" },
      { alt: "silo-3", src: "/img/silo/3.png" },
      { alt: "silo-3", src: "/img/silo/4.png" },
    ],
  },
];
